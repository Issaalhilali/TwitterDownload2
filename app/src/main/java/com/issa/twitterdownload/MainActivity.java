...
public class MainActivity extends AppCompatActivity {
    ...
    public void getTweet(final Long id, final String fname){
        ...
        tweetCall.enqueue(new Callback<Tweet>() {
            ...
            public void failure(TwitterException exception) {
                progressDialog.hide();
                Toast.makeText(MainActivity.this, getString(R.string.chek_connection), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void downloadVideo(String url,String fname) {
        ...
        if (fname.endsWith(".mp4")) {
            progressDialog.setMessage(getString(R.string.fetch_video));
        }else{
            progressDialog.setMessage(getString(R.string.fetch_gif));
        }
        ...
        if (!storageAllowed()) {
            ...
            ActivityCompat.requestPermissions(this, Constant.PERMISSIONS_STORAGE, Constant.REQUEST_EXTERNAL_STORAGE);
            progressDialog.hide();
            Toast.makeText(this,getString(R.string.kindly), Toast.LENGTH_SHORT).show();
        }else {
            RxDownloader.getInstance(this)
                    ...
                    .subscribe(new Observer<String>() {
                        ...
                        public void onCompleted() {
                            Toast.makeText(MainActivity.this, getString(R.string.completed), Toast.LENGTH_SHORT).show();
                            loadLikeDialog();
                        }
