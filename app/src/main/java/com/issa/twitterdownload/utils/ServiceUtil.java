...
public class ServiceUtil {
        ...
        private static void alertNoVideo() {
            Toast.makeText(c, c.getString(R.string.containt_tweet), Toast.LENGTH_LONG).show();
        }

        private static void alertNoMedia() {
            Toast.makeText(c,c.getString(R.string.media_file), Toast.LENGTH_LONG).show();
        }

        private static void alertNoUrl() {
            Toast.makeText(c,c.getString(R.string.not_tweet), Toast.LENGTH_LONG).show();
        }


        private static void showFetchingTweetNoti() {
            Toast.makeText(c,c.getString(R.string.tch), Toast.LENGTH_LONG).show();
        }
        ...
        private static void getTweet(final Long id, final String fname){
            ...
            tweetCall.enqueue(new Callback<Tweet>() {
                ...
                public void failure(TwitterException exception) {
                    Toast.makeText(c, c.getString(R.string.requset_failed), Toast.LENGTH_SHORT).show();
                }
            });
        }
...
//            ActivityCompat.requestPermissions(c, Constant.PERMISSIONS_STORAGE, Constant.REQUEST_EXTERNAL_STORAGE);
                Toast.makeText(c,c.getString(R.string.kindly), Toast.LENGTH_SHORT).show();
            }else {
                RxDownloader.getInstance(c)
                        ...
                        .subscribe(new Observer<String>() {
                            ...
                            public void onCompleted() {
                                Toast.makeText(c,c.getString(R.string.completed) , Toast.LENGTH_SHORT).show();
                            }
                ...
                Toast.makeText(c,c.getString(R.string.check_notification) , Toast.LENGTH_LONG).show();
            }
        }
